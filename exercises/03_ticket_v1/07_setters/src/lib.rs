...
impl Ticket {
    fn check_title(title: String) -> String {
        if title.is_empty() {
    ...
    fn check_description(desc: String) -> String {
        if desc.is_empty() {
    ...
    fn check_status(status: String) -> String {
    ...
    pub fn set_description(&mut self, desc: String) {
        self.description = Self::check_description(desc);
    }
